...
const Footer = /* @__PURE__ */ componentQrl(inlinedQrl(() => /* @__PURE__ */ jsx("footer", {
  children: /* @__PURE__ */ jsx("a", {
    href: "https://github.com/jonatanpetersson",
    target: "_blank",
    children: "github.com/jonatanpetersson"
  })
}), "s_hg9USy095T4"));
const isServer = true;
...
const GithubIcon = /* @__PURE__ */ componentQrl(inlinedQrl(() => /* @__PURE__ */ jsx("svg", {
...
const NoteIcon = /* @__PURE__ */ componentQrl(inlinedQrl(() => /* @__PURE__ */ jsx("svg", {
  xmlns: "http://www.w3.org/2000/svg",
    ...
    children: [
      /* @__PURE__ */ jsx("h1", {
        children: /* @__PURE__ */ jsx(Link, {
          href: "/",
          children: "Just testing this real Qwik"
        })
      }),
      /* @__PURE__ */ jsx("nav", {
        children: [
    ...
    children: [
      /* @__PURE__ */ jsx("p", {
        children: [
          ...
          " ",
          "by building some basic stuff. Routing, api calls, state management, shared components etc."
        ]
      }),
      /* @__PURE__ */ jsx("p", {
        children: "In terms of DX it's very similar to React, this also uses JSX. But it comes with simplified syntax in many ways."
      }),
      /* @__PURE__ */ jsx("p", {
        children: `Working with state for instance, there's no need for a setState function. A simple "state =" assignment is enough.`
      }),
      /* @__PURE__ */ jsx("p", {
        children: "I've only scratched the surface on the really powerful stuff like lazy loading and serializing, and this is where it seem to differ the most from React also DX-wise with a different life cycle and hooks."
      }),
      /* @__PURE__ */ jsx("p", {
        children: "Also, the docs are absolutely amazing."
      })
    ]
  });
}, "s_xYL1qOwPyDI"));
...
(function(ContextType2) {
  ContextType2[ContextType2["GithubRepos"] = 0] = "GithubRepos";
  ContextType2[ContextType2["Todos"] = 1] = "Todos";
})(ContextType || (ContextType = {}));
const Context = createContext$1("context");
const styles$2 = "button {\r\n  font-size: 1.1rem;\r\n  align-self: flex-end;\r\n  width: fit-content;\r\n  font-weight: bold;\r\n  padding: 0.8rem 1.2rem;\r\n  background-color: #005f73;\r\n  border: none;\r\n  color: #fff;\r\n  cursor: pointer;\r\n  border-radius: 2px;\r\n}\r\n";
const Button = /* @__PURE__ */ componentQrl(inlinedQrl(({ clickHandler, label }) => {
  useStylesScopedQrl(inlinedQrl(styles$2, "s_T5tZ6LbxyrQ"));
  return /* @__PURE__ */ jsx("button", {
    onClick$: clickHandler,
    children: label
  });
}, "s_teqaZ0m2jjQ"));
const styles$1 = ".todo-list-item {\r\n  padding: 1.6rem;\r\n  gap: 0.8rem;\r\n  display: flex;\r\n  flex-direction: column;\r\n  border-radius: 0.3rem;\r\n  width: 18.2rem;\r\n  background-color: #94d2bd;\r\n}\r\n";
const ListItem = /* @__PURE__ */ componentQrl(inlinedQrl(({ ctxType, idx }) => {
  useStylesScopedQrl(inlinedQrl(styles$1, "s_qppkwbXI7v0"));
  const ctx = useContext(Context);
  const item = ctx[ctxType][idx];
  const deleteItem = inlinedQrl(() => {
    const [ctx2, ctxType2, idx2] = useLexicalScope();
    return ctx2[ctxType2] = ctx2[ctxType2].filter((_, i) => i !== idx2);
  }, "s_vaoAwweHOKk", [
    ctx,
    ctxType,
    idx
  ...
  return /* @__PURE__ */ jsx("li", {
    className: ctxType === ContextType.Todos ? "todo-list-item" : "",
    children: [
      ctxType === ContextType.GithubRepos && /* @__PURE__ */ jsx("a", {
        href: item,
        target: "_blank",
        children: item.split("/").at(-1)
      }),
      ctxType === ContextType.Todos && /* @__PURE__ */ jsx(Fragment, {
        children: [
          /* @__PURE__ */ jsx("span", {
            children: item
          }),
...
const index$1 = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  const input = useStore({
    value: "jonatanpetersson"
  });
  const setUserName = inlinedQrl((ev) => {
    const [input2] = useLexicalScope();
    return input2.value = ev.target.value;
  }, "s_pd1ztnrt8mI", [
    input
  ]);
  const reposResource = useResourceQrl(inlinedQrl(async ({ track, cleanup }) => {
    const [input2] = useLexicalScope();
    const userName = track(input2, "value");
    const abortController = new AbortController();
    cleanup(() => abortController.abort("cleanup"));
    const res = await new Promise((res2) => setTimeout(async () => {
      const result = await fetch(`https://api.github.com/users/${userName}/repos`, {
        signal: abortController.signal
      });
      res2(result);
    }, 1e3));
    const repos2 = await res.json();
    return repos2.map((r) => `https://github.com/${userName}/${r.name}`);
  }, "s_iN71rMxN3u8", [
    input
  ]));
  const onReposResourceResolved = (reposList) => {
    ctx[repos] = reposList;
    return /* @__PURE__ */ jsx("ul", {
      children: ctx[repos].map((_, idx) => /* @__PURE__ */ jsx(ListItem, {
        idx,
        ctxType: repos
      }))
    });
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsx(Resource, {
        ...
        onRejected: () => /* @__PURE__ */ jsx("div", {
          children: "Failed to load repos. Make sure the username is correct."
        }),
...
const Githubrepos = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: index$1
}, Symbol.toStringTag, { value: "Module" }));
const styles = ".todo-form {\r\n  width: fit-content;\r\n  display: flex;\r\n  flex-direction: column;\r\n  margin-bottom: 1.6rem;\r\n}\r\nul {\r\n  overflow: auto;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 0.8rem;\r\n}\r\n";
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  var _a2;
  useStylesScopedQrl(inlinedQrl(styles, "s_7cPXc8h9yyI"));
  const ctx = useContext(Context);
  const input = useRef();
  const todos = ContextType.Todos;
  const addTodo = inlinedQrl(() => {
    const [ctx2, input2, todos2] = useLexicalScope();
    return ctx2[todos2] = [
      ...ctx2[todos2],
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: [
      ...
      !!((_a2 = ctx[todos]) == null ? void 0 : _a2.length) && /* @__PURE__ */ jsx("ul", {
        children: ctx[todos].map((_, idx) => /* @__PURE__ */ jsx(ListItem, {
          idx,
          ctxType: todos
        }))
      })
...
const Todo = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: index
}, Symbol.toStringTag, { value: "Module" }));
const Layout = () => Layout_;
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-a0188b4d.js", "q-3ed430b2.js"]],
  [/^\/github-repos\/?$/, [Layout, () => Githubrepos], void 0, "/github-repos", ["q-a0188b4d.js", "q-56123e2e.js"]],
  [/^\/todo\/?$/, [Layout, () => Todo], void 0, "/todo", ["q-a0188b4d.js", "q-662a28ca.js"]]
];
const menus = [];
...
const manifest = { "symbols": { "s_hA9UPaY8sNQ": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "Link_component_a_onClick", "canonicalFilename": "s_ha9upay8snq", "hash": "hA9UPaY8sNQ", "ctxKind": "event", "ctxName": "onClick$", "captures": true, "parent": "s_mYsiJcA4IBc" }, "s_skxgNVWVOT8": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "Link_component_a_onMouseOver", "canonicalFilename": "s_skxgnvwvot8", "hash": "skxgNVWVOT8", "ctxKind": "event", "ctxName": "onMouseOver$", "captures": false, "parent": "s_mYsiJcA4IBc" }, "s_uVE5iM9H73c": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "Link_component_a_onQVisible", "canonicalFilename": "s_uve5im9h73c", "hash": "uVE5iM9H73c", "ctxKind": "event", "ctxName": "onQVisible$", "captures": false, "parent": "s_mYsiJcA4IBc" }, "s_AaAlzKH0KlQ": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "QwikCity_component_useWatch", "canonicalFilename": "s_aaalzkh0klq", "hash": "AaAlzKH0KlQ", "ctxKind": "function", "ctxName": "useWatch$", "captures": true, "parent": "s_z1nvHyEppoI" }, "s_0i50F5e0ogw": { "origin": "components/head/head.tsx", "displayName": "Head_component", "canonicalFilename": "s_0i50f5e0ogw", "hash": "0i50F5e0ogw", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_3sccYCDd1Z0": { "origin": "root.tsx", "displayName": "root_component", "canonicalFilename": "s_3sccycdd1z0", "hash": "3sccYCDd1Z0", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_I1sFF4jynuA": { "origin": "routes/github-repos/index.tsx", "displayName": "github_repos_component", "canonicalFilename": "s_i1sff4jynua", "hash": "I1sFF4jynuA", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_Mb2EdTfTCZ0": { "origin": "assets/icons/note-icon.tsx", "displayName": "NoteIcon_component", "canonicalFilename": "s_mb2edtftcz0", "hash": "Mb2EdTfTCZ0", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_VkLNXphUh5s": { "origin": "routes/layout.tsx", "displayName": "layout_component", "canonicalFilename": "s_vklnxphuh5s", "hash": "VkLNXphUh5s", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_ceU05TscGYE": { "origin": "components/header/header.tsx", "displayName": "header_component", "canonicalFilename": "s_ceu05tscgye", "hash": "ceU05TscGYE", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_hT8Fw6FQhrg": { "origin": "assets/icons/github-icon.tsx", "displayName": "GithubIcon_component", "canonicalFilename": "s_ht8fw6fqhrg", "hash": "hT8Fw6FQhrg", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_hg9USy095T4": { "origin": "components/footer/footer.tsx", "displayName": "Footer_component", "canonicalFilename": "s_hg9usy095t4", "hash": "hg9USy095T4", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_mYsiJcA4IBc": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "Link_component", "canonicalFilename": "s_mysijca4ibc", "hash": "mYsiJcA4IBc", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_nd8yk3KO22c": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "RouterOutlet_component", "canonicalFilename": "s_nd8yk3ko22c", "hash": "nd8yk3KO22c", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_noUOWecEIrA": { "origin": "components/shared/list-item/list-item.tsx", "displayName": "ListItem_component", "canonicalFilename": "s_nouoweceira", "hash": "noUOWecEIrA", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_teqaZ0m2jjQ": { "origin": "components/shared/button/button.tsx", "displayName": "Button_component", "canonicalFilename": "s_teqaz0m2jjq", "hash": "teqaZ0m2jjQ", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_xFDrsBvI5Fo": { "origin": "routes/todo/index.tsx", "displayName": "todo_component", "canonicalFilename": "s_xfdrsbvi5fo", "hash": "xFDrsBvI5Fo", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_xYL1qOwPyDI": { "origin": "routes/index.tsx", "displayName": "routes_component", "canonicalFilename": "s_xyl1qowpydi", "hash": "xYL1qOwPyDI", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_z1nvHyEppoI": { "origin": "../node_modules/@builder.io/qwik-city/index.qwik.mjs", "displayName": "QwikCity_component", "canonicalFilename": "s_z1nvhyeppoi", "hash": "z1nvHyEppoI", "ctxKind": "function", "ctxName": "component$", "captures": false, "parent": null }, "s_7cPXc8h9yyI": { "origin": "routes/todo/index.tsx", "displayName": "todo_component_useStylesScoped", "canonicalFilename": "s_7cpxc8h9yyi", "hash": "7cPXc8h9yyI", "ctxKind": "function", "ctxName": "useStylesScoped$", "captures": false, "parent": "s_xFDrsBvI5Fo" }, "s_T5tZ6LbxyrQ": { "origin": "components/shared/button/button.tsx", "displayName": "Button_component_useStylesScoped", "canonicalFilename": "s_t5tz6lbxyrq", "hash": "T5tZ6LbxyrQ", "ctxKind": "function", "ctxName": "useStylesScoped$", "captures": false, "parent": "s_teqaZ0m2jjQ" }, "s_qppkwbXI7v0": { "origin": "components/shared/list-item/list-item.tsx", "displayName": "ListItem_component_useStylesScoped", "canonicalFilename": "s_qppkwbxi7v0", "hash": "qppkwbXI7v0", "ctxKind": "function", "ctxName": "useStylesScoped$", "captures": false, "parent": "s_noUOWecEIrA" }, "s_aG6brLW6OfE": { "origin": "routes/todo/index.tsx", "displayName": "todo_component_addTodo", "canonicalFilename": "s_ag6brlw6ofe", "hash": "aG6brLW6OfE", "ctxKind": "function", "ctxName": "$", "captures": true, "parent": "s_xFDrsBvI5Fo" }, "s_iN71rMxN3u8": { "origin": "routes/github-repos/index.tsx", "displayName": "github_repos_component_reposResource_useResource", "canonicalFilename": "s_in71rmxn3u8", "hash": "iN71rMxN3u8", "ctxKind": "function", "ctxName": "useResource$", "captures": true, "parent": "s_I1sFF4jynuA" }, "s_pd1ztnrt8mI": { "origin": "routes/github-repos/index.tsx", "displayName": "github_repos_component_setUserName", "canonicalFilename": "s_pd1ztnrt8mi", "hash": "pd1ztnrt8mI", "ctxKind": "function", "ctxName": "$", "captures": true, "parent": "s_I1sFF4jynuA" }, "s_vaoAwweHOKk": { "origin": "components/shared/list-item/list-item.tsx", "displayName": "ListItem_component_deleteItem", "canonicalFilename": "s_vaoawwehokk", "hash": "vaoAwweHOKk", "ctxKind": "function", "ctxName": "$", "captures": true, "parent": "s_noUOWecEIrA" } }, "mapping": { "s_hA9UPaY8sNQ": "q-bee523f5.js", "s_skxgNVWVOT8": "q-bee523f5.js", "s_uVE5iM9H73c": "q-bee523f5.js", "s_AaAlzKH0KlQ": "q-398bb738.js", "s_0i50F5e0ogw": "q-fc9ed31f.js", "s_3sccYCDd1Z0": "q-e7436319.js", "s_I1sFF4jynuA": "q-73222cea.js", "s_Mb2EdTfTCZ0": "q-fe23b8aa.js", "s_VkLNXphUh5s": "q-8f5c78c3.js", "s_ceU05TscGYE": "q-74afcc1c.js", "s_hT8Fw6FQhrg": "q-5a9b7589.js", "s_hg9USy095T4": "q-a49332ca.js", "s_mYsiJcA4IBc": "q-bee523f5.js", "s_nd8yk3KO22c": "q-2b92d44b.js", "s_noUOWecEIrA": "q-cc590ca9.js", "s_teqaZ0m2jjQ": "q-307e76ef.js", "s_xFDrsBvI5Fo": "q-806b5e2b.js", "s_xYL1qOwPyDI": "q-227402a8.js", "s_z1nvHyEppoI": "q-398bb738.js", "s_7cPXc8h9yyI": "q-806b5e2b.js", "s_T5tZ6LbxyrQ": "q-307e76ef.js", "s_qppkwbXI7v0": "q-cc590ca9.js", "s_aG6brLW6OfE": "q-806b5e2b.js", "s_iN71rMxN3u8": "q-73222cea.js", "s_pd1ztnrt8mI": "q-73222cea.js", "s_vaoAwweHOKk": "q-cc590ca9.js" }, "bundles": { "q-0dabce28.js": { "size": 128, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-143c7194.js"], "origins": ["@qwik-city-entries"] }, "q-1352b4c1.js": { "size": 58, "imports": ["q-95daaf90.js"] }, "q-143c7194.js": { "size": 2180, "origins": ["node_modules/@builder.io/qwik-city/service-worker.mjs", "src/routes/service-worker.js"] }, "q-227402a8.js": { "size": 860, "imports": ["q-95daaf90.js"], "origins": ["src/entry_routes.js", "src/s_xyl1qowpydi.js"], "symbols": ["s_xYL1qOwPyDI"] }, "q-2b92d44b.js": { "size": 269, "imports": ["q-95daaf90.js", "q-e7436319.js"], "origins": ["src/entry_RouterOutlet.js", "src/s_nd8yk3ko22c.js"], "symbols": ["s_nd8yk3KO22c"] }, "q-307e76ef.js": { "size": 575, "imports": ["q-95daaf90.js"], "origins": ["src/components/shared/button/button.css?used", "src/entry_Button.js", "src/s_t5tz6lbxyrq.js", "src/s_teqaz0m2jjq.js"], "symbols": ["s_T5tZ6LbxyrQ", "s_teqaZ0m2jjQ"] }, "q-398bb738.js": { "size": 1489, "imports": ["q-95daaf90.js", "q-e7436319.js"], "dynamicImports": ["q-3a9d6673.js"], "origins": ["@builder.io/qwik/build", "src/entry_QwikCity.js", "src/s_aaalzkh0klq.js", "src/s_z1nvhyeppoi.js"], "symbols": ["s_AaAlzKH0KlQ", "s_z1nvHyEppoI"] }, "q-3a9d6673.js": { "size": 501, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-0dabce28.js", "q-3ed430b2.js", "q-56123e2e.js", "q-662a28ca.js", "q-a0188b4d.js"], "origins": ["@qwik-city-plan"] }, "q-3ed430b2.js": { "size": 158, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-227402a8.js"], "origins": ["src/routes/index.js"] }, "q-56123e2e.js": { "size": 158, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-73222cea.js"], "origins": ["src/routes/github-repos/index.js"] }, "q-5a9b7589.js": { "size": 695, "imports": ["q-95daaf90.js"], "origins": ["src/entry_GithubIcon.js", "src/s_ht8fw6fqhrg.js"], "symbols": ["s_hT8Fw6FQhrg"] }, "q-662a28ca.js": { "size": 158, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-806b5e2b.js"], "origins": ["src/routes/todo/index.js"] }, "q-73222cea.js": { "size": 1462, "imports": ["q-95daaf90.js", "q-a63dc33a.js", "q-e7436319.js"], "origins": ["src/entry_github_repos.js", "src/s_i1sff4jynua.js", "src/s_in71rmxn3u8.js", "src/s_pd1ztnrt8mi.js"], "symbols": ["s_I1sFF4jynuA", "s_iN71rMxN3u8", "s_pd1ztnrt8mI"] }, "q-74afcc1c.js": { "size": 558, "imports": ["q-95daaf90.js", "q-e7436319.js"], "dynamicImports": ["q-5a9b7589.js", "q-fe23b8aa.js"], "origins": ["src/assets/icons/github-icon.js", "src/assets/icons/note-icon.js", "src/entry_header.js", "src/s_ceu05tscgye.js"], "symbols": ["s_ceU05TscGYE"] }, "q-806b5e2b.js": { "size": 1224, "imports": ["q-86fc7e82.js", "q-95daaf90.js", "q-a63dc33a.js", "q-e7436319.js"], "origins": ["src/entry_todo.js", "src/routes/todo/todo.css?used&inline", "src/s_7cpxc8h9yyi.js", "src/s_ag6brlw6ofe.js", "src/s_xfdrsbvi5fo.js"], "symbols": ["s_7cPXc8h9yyI", "s_aG6brLW6OfE", "s_xFDrsBvI5Fo"] }, "q-86fc7e82.js": { "size": 147, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-307e76ef.js"], "origins": ["src/components/shared/button/button.js"] }, "q-8f5c78c3.js": { "size": 334, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-74afcc1c.js", "q-a49332ca.js"], "origins": ["src/components/footer/footer.js", "src/components/header/header.js", "src/entry_layout.js", "src/s_vklnxphuh5s.js"], "symbols": ["s_VkLNXphUh5s"] }, "q-95daaf90.js": { "size": 36682, "dynamicImports": ["q-e7436319.js"], "origins": ["\0vite/preload-helper", "node_modules/@builder.io/qwik/core.min.mjs", "src/global.css", "src/root.js"] }, "q-a0188b4d.js": { "size": 158, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-8f5c78c3.js"], "origins": ["src/routes/layout.js"] }, "q-a49332ca.js": { "size": 206, "imports": ["q-95daaf90.js"], "origins": ["src/entry_Footer.js", "src/s_hg9usy095t4.js"], "symbols": ["s_hg9USy095T4"] }, "q-a63dc33a.js": { "size": 152, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-cc590ca9.js"], "origins": ["src/components/shared/list-item/list-item.js"] }, "q-bee523f5.js": { "size": 886, "imports": ["q-95daaf90.js", "q-e7436319.js"], "origins": ["src/entry_Link.js", "src/s_ha9upay8snq.js", "src/s_mysijca4ibc.js", "src/s_skxgnvwvot8.js", "src/s_uve5im9h73c.js"], "symbols": ["s_hA9UPaY8sNQ", "s_mYsiJcA4IBc", "s_skxgNVWVOT8", "s_uVE5iM9H73c"] }, "q-cc590ca9.js": { "size": 1091, "imports": ["q-86fc7e82.js", "q-95daaf90.js", "q-e7436319.js"], "origins": ["src/components/shared/list-item/list-item.css?used", "src/entry_ListItem.js", "src/s_nouoweceira.js", "src/s_qppkwbxi7v0.js", "src/s_vaoawwehokk.js"], "symbols": ["s_noUOWecEIrA", "s_qppkwbXI7v0", "s_vaoAwweHOKk"] }, "q-e7436319.js": { "size": 4659, "imports": ["q-95daaf90.js"], "dynamicImports": ["q-2b92d44b.js", "q-398bb738.js", "q-3a9d6673.js", "q-bee523f5.js", "q-fc9ed31f.js"], "origins": ["node_modules/@builder.io/qwik-city/index.qwik.mjs", "src/components/head/head.js", "src/context/context.js", "src/entry_root.js", "src/s_3sccycdd1z0.js"], "symbols": ["s_3sccYCDd1Z0"] }, "q-fc9ed31f.js": { "size": 814, "imports": ["q-95daaf90.js", "q-e7436319.js"], "origins": ["src/entry_Head.js", "src/s_0i50f5e0ogw.js"], "symbols": ["s_0i50F5e0ogw"] }, "q-fe23b8aa.js": { "size": 560, "imports": ["q-95daaf90.js"], "origins": ["src/entry_NoteIcon.js", "src/s_mb2edtftcz0.js"], "symbols": ["s_Mb2EdTfTCZ0"] } }, "injections": [{ "tag": "link", "location": "head", "attributes": { "rel": "stylesheet", "href": "/build/q-b48cedff.css" } }, { "tag": "link", "location": "head", "attributes": { "rel": "stylesheet", "href": "/build/q-ba2460aa.css" } }, { "tag": "link", "location": "head", "attributes": { "rel": "stylesheet", "href": "/build/q-93ddc229.css" } }], "version": "1", "options": { "target": "client", "buildMode": "production", "forceFullBuild": true, "entryStrategy": { "type": "smart" } }, "platform": { "qwik": "0.9.0", "vite": "", "rollup": "2.78.1", "env": "node", "os": "win32", "node": "16.16.0" } };
